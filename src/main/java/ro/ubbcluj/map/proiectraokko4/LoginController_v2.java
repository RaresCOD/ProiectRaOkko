...
public class LoginController_v2 {
    ...
    public void handleLoginButton(ActionEvent actionEvent) {
        ...
        Long id = service.Login(userName, pass);
        if( id != null) {
            try {
    ...
    public void handleRegisterButton(ActionEvent actionEvent) {
        ...
        try{
            ...
            Utilizator user = service.addUtilizator(username, firstName, lastName, passReg);
            try {
                FXMLLoader fxmlLoader = new FXMLLoader();
                fxmlLoader.setLocation(getClass().getResource("views/home_v3.fxml"));
                Scene scene = new Scene(fxmlLoader.load());
                ...
                stage.setScene(scene);
                UI_v2_Controller userInterface = fxmlLoader.getController();
                userInterface.setService(service, user.getId());
                stage.show();
                ((Node)(actionEvent.getSource())).getScene().getWindow().hide();
            } catch (IOException e) {
                e.printStackTrace();
